...
# Load clean image
fname = 'data/denoising/image_Lena512rgb.png' 
...
img_noisy_pil.save('data/denoising/noisy_image_Lena512rgb.png')
...
out_img_avg_pil.save(f'data/denoising/denoised_image_Lena512rgb.png')